...
const CopyableAddress = ({ label, address }: { label: string, address: string }) => {
  ...
  return (
    <div className="crypto-donation-card">
      <div className="crypto-label">{label}</div>
  ...
  <article className="static-content support-container">
    ...
    <section className="support-section">
      ...
      <div className="referral-grid">
        ...
        <a href="https://t.me/cointbot_bit_bot?start=ref_136770_te7" target="_blank" rel="noopener noreferrer" className="referral-card">
          <h3>CoinTBot Bit Bot (Telegram)</h3>
    ...
    <section className="support-section">
      ...
      <div className="donation-grid">
        <CopyableAddress label="Bitcoin (BTC)" address="bc1qynmu7c78r9mf9u3w4u90d6rq2qhdt95ajqrsum" />
        <CopyableAddress label="Ethereum (ETH) - ERC20" address="0x702aE8866AAa6832Bd5134df61a9a9e44634019f" />
        <CopyableAddress label="Binance Coin (BNB)" address="0x702aE8866AAa6832Bd5134df61a9a9e44634019f" />
        <CopyableAddress label="Solana (SOL)" address="Fh2kJhbCsj4vUbq9162qiL73h2UHbaBNtWc5qrmvif7q" />
        <CopyableAddress label="Polygon (MATIC/POL)" address="0x702aE8866AAa6832Bd5134df61a9a9e44634019f" />
        <CopyableAddress label="TRON (TRX)" address="TGDiPJXsAHncA1FBsd4ihXMk6euRPHsvHt" />
      </div>
    </section>
  </article>
);
