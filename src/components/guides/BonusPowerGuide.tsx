  ...
  return (
    <div className="static-page-container">
      ...
      <article className="static-content guides-container">
        ...
        <h2>3. Envanterde Saklama (Storage) Özelliği</h2>
        <p>Çoğu yeni oyuncunun bilmediği inanılmaz bir mekanik detay: Bir madenciden bonus elde etmek için o cihazın illa bir rafa (Rack) konulmasına gerek yoktur! Sırf bonus versin diye aldığınız yüzlerce küçük madenciyi, limitli raflarınızı işgal etmesin diye deponuzda (Item Envanterinde) tutabilirsiniz.</p>
        <p>Bonus yüzdesi, cihaz odada olmasa bile profilinize kalıcı olarak yansır. Odanızı sadece "El Monstro" tarzı devasa üretim yapan ana makinelere ayırın. Bu sayede gereksiz raf maliyetinden (Racks) ve batarya israfından kurtulmuş olursunuz.</p>
  ...
  return (
    <div className="static-page-container">
      ...
      <article className="static-content guides-container">
        ...
        <p>Every unique (different) miner you add to your inventory (or racks) applies a bonus multiplier percentage (%) to the raw power in your entire room. If you own 2 instances of Miner X, the bonus applies <strong>only once (%x)</strong>. Because of this, "diversity" is far more important than "quantity".</p>
        <p>Let's say the total raw power of all miners in your room is 100 PH/s. If you add to your inventory an old event device that has very low raw power but giving a 1% bonus, your total bonus percentage jumps from 10% to 11%. This tiny increment instantly grants you an extra 1 PH/s of power in a 100 PH/s pool with absolutely zero electricity cost!</p>
        ...
        <h2>3. The Storage Feature</h2>
        <p>An incredible mechanical detail that many new players are unaware of: To gain the bonus from a miner, it does NOT have to be placed on a rack! Hundreds of tiny miners that you bought solely for their bonus can sit comfortably in your storage (Item Inventory) so that they don't occupy your limited rack spaces.</p>
        <p>The bonus percentage permanently reflects upon your profile even if the device isn't active in a room. Reserve your rooms exclusively for massive producing heavy-hitters like "El Monstro". This way, you avoid unnecessary rack costs and battery wastage.</p>
