  ...
  return (
    <div className="static-page-container">
      ...
      <article className="static-content guides-container">
        ...
        <p>Koleksiyon bonusunuzun aktif olması için artık tüm madencilerinizin ana odanıza dizilmiş ve rafa yerleştirilmiş olması gerekmektedir. Eskiden olduğu gibi envanterde saklamak bonus sağlamaz. Ayriyeten oyundaki en prestijli ve en devasa ana cihazlarınız için "Raf" (Rack) konumlandırma stratejileri ve batarya kullanımı hayati önem taşır. RollerCoin pazar yerindeki özel yapım raflar size %4, %6 veya %8 ekstra bonus verebilir.</p>
  ...
  return (
    <div className="static-page-container">
      ...
      <article className="static-content guides-container">
        ...
        <p>The undisputed winners of the 2026 season are the players who obsess meticulously over the "Collection Bonus" percentage attached to every single miner they purchase. Every unique miner you place in your mining rooms (on a rack) automatically bumps up your entire account's Raw Hash power by its native percentage. The higher your global bonus percentage climbs, the more valuable every future raw power miner purchase becomes.</p>
        ...
        <p>To gain the Collection Bonus, you must now explicitly place your miners actively in your game rooms on a rack. Storage no longer provides bonus power. Furthermore, for your most prestigious, most gigantic primary devices, "Rack" positioning strategies and battery durability are a matter of life and death. The custom-built racks available on the RollerCoin marketplace can bless the devices housed upon them with a 4%, 6%, or staggering 8% extra bonus yield.</p>
